    ...
    "services": {
      "Instagram Likes": {
        ...
        "priceRanges": [
          ...
          { min: 350, max: 350, pricePerUnit: 11.99 },
          { min: 500, max: 500, pricePerUnit: 14.99 },
          { min: 750, max: 750, pricePerUnit: 16.99 },
          { min: 1000, max: 1000, pricePerUnit: 19.99 },
          { min: 2500, max: 2500, pricePerUnit: 24.99 },
          { min: 2800, max: 2800, pricePerUnit: 26.99 },
          { min: 3500, max: 3500, pricePerUnit: 39.99 },
          { min: 5000, max: 5000, pricePerUnit: 45.99 },
          { min: 7500, max: 7500, pricePerUnit: 65.99 },
          { min: 10000, max: 10000, pricePerUnit: 109.99 }
        ],
        "extraOptions": {
          "premiumGuarantee": {
            "additionalPrice": 2.99
      ...
      "Instagram Followers": {
        ...
        "priceRanges": [
          { min: 10, max: 10, pricePerUnit: 3.99 },
          { min: 25, max: 25, pricePerUnit: 5.99 },
          { min: 100, max: 100, pricePerUnit: 8.99 },
          { min: 250, max: 250, pricePerUnit: 11.99 },
          { min: 350, max: 350, pricePerUnit: 14.99 },
          { min: 500, max: 500, pricePerUnit: 18.99 },
          { min: 750, max: 750, pricePerUnit: 24.99 },
          { min: 1000, max: 1000, pricePerUnit: 29.99 },
          { min: 2500, max: 2500, pricePerUnit: 34.99 },
          { min: 5000, max: 5000, pricePerUnit: 46.99 },
          { min: 7500, max: 7500, pricePerUnit: 59.99 },
          { min: 10000, max: 10000, pricePerUnit: 129.99 }
        ],
        "extraOptions": {
      ...
      "Instagram Views": {
        ...
        "priceRanges": [
          ...
          { min: 250, max: 250, pricePerUnit: 3.99 },
          { min: 500, max: 500, pricePerUnit: 5.99 },
          { min: 750, max: 750, pricePerUnit: 8.99 },
          { min: 1000, max: 1000, pricePerUnit: 12.99 },
          { min: 1700, max: 1700, pricePerUnit: 16.99 },
          { min: 2500, max: 2500, pricePerUnit: 22.99 },
          { min: 3500, max: 3500, pricePerUnit: 25.99 },
          { min: 5000, max: 5000, pricePerUnit: 29.99 },
          { min: 7500, max: 7500, pricePerUnit: 34.99 },
          { min: 8500, max: 8500, pricePerUnit: 39.99 },
          { min: 10000, max: 10000, pricePerUnit: 42.99 },
          { min: 25000, max: 25000, pricePerUnit: 49.99 },
          { min: 35000, max: 35000, pricePerUnit: 59.99 },
          { min: 50000, max: 50000, pricePerUnit: 79.99 }
        ],
        "extraOptions": {
          "premiumGuarantee": {
            "additionalPrice": 2.99
    ...
    "services": {
      "Facebook Likes (Post Likes)": {
        ...
        "priceRanges": [
          ...
          { "min": 50, "max": 50, "pricePerUnit": 5.99 },
          { "min": 100, "max": 100, "pricePerUnit": 7.99 },
          { "min": 250, "max": 250, "pricePerUnit": 8.49 },
          { "min": 350, "max": 350, "pricePerUnit": 9.99 },
          { "min": 500, "max": 500, "pricePerUnit": 11.99 },
          { "min": 750, "max": 750, "pricePerUnit": 16.99 },
          { "min": 1000, "max": 1000, "pricePerUnit": 19.99 },
          { "min": 1800, "max": 1800, "pricePerUnit": 25.99 },
          { "min": 2500, "max": 2500, "pricePerUnit": 32.99 },
          { "min": 3800, "max": 3800, "pricePerUnit": 39.99 },
          { "min": 5000, "max": 5000, "pricePerUnit": 59.99 }
        ],
        "extraOptions": {
          "premiumGuarantee": {
            "additionalPrice": 2.99
      ...
      "Facebook Page Likes (Page/Fanpage Likes)": {
        ...
        "priceRanges": [
          ...
          { "min": 25, "max": 25, "pricePerUnit": 4.99 },
          { "min": 50, "max": 50, "pricePerUnit": 7.99 },
          { "min": 75, "max": 75, "pricePerUnit": 9.99 },
          { "min": 100, "max": 100, "pricePerUnit": 12.99 },
          { "min": 250, "max": 250, "pricePerUnit": 16.99 },
          { "min": 350, "max": 350, "pricePerUnit": 19.99 },
          { "min": 500, "max": 500, "pricePerUnit": 25.59 },
          { "min": 750, "max": 750, "pricePerUnit": 29.99 },
          { "min": 1000, "max": 1000, "pricePerUnit": 34.99 },
          { "min": 1500, "max": 1500, "pricePerUnit": 39.99 },
          { "min": 2800, "max": 2800, "pricePerUnit": 49.99 },
          { "min": 3500, "max": 3500, "pricePerUnit": 59.99 },
          { "min": 5000, "max": 5000, "pricePerUnit": 89.99 }
        ],
        "extraOptions": {
          "premiumGuarantee": {
            "additionalPrice": 2.99
      ...
      "Facebook Views (For Videos)": {
        ...
        "priceRanges": [
          ...
          { "min": 1000, "max": 1000, "pricePerUnit": 8.99 },
          { "min": 2500, "max": 2500, "pricePerUnit": 12.99 },
          { "min": 3800, "max": 3800, "pricePerUnit": 14.99 },
          { "min": 4500, "max": 4500, "pricePerUnit": 16.99 },
          { "min": 5000, "max": 5000, "pricePerUnit": 18.99 },
          { "min": 7500, "max": 7500, "pricePerUnit": 25.99 },
          { "min": 10000, "max": 10000, "pricePerUnit": 34.99 }
        ],
        "extraOptions": {
          "premiumGuarantee": {
            "additionalPrice": 2.99
  ...
  "YouTube": {
    ...
    "services": {
      "YouTube Likes": {
        ...
        "priceRanges": [
          { "min": 10, "max": 10, "pricePerUnit": 3.49 },
          { "min": 35, "max": 35, "pricePerUnit": 4.49 },
          { "min": 50, "max": 50, "pricePerUnit": 5.49 },
          { "min": 100, "max": 100, "pricePerUnit": 6.99 },
          { "min": 250, "max": 250, "pricePerUnit": 8.99 },
          { "min": 350, "max": 350, "pricePerUnit": 9.99 },
          { "min": 500, "max": 500, "pricePerUnit": 12.99 },
          { "min": 750, "max": 750, "pricePerUnit": 16.99 },
          { "min": 1000, "max": 1000, "pricePerUnit": 19.99 },
          { "min": 2500, "max": 2500, "pricePerUnit": 29.99 },
          { "min": 3500, "max": 3500, "pricePerUnit": 36.99 },
          { "min": 4800, "max": 4800, "pricePerUnit": 49.99 },
          { "min": 5000, "max": 5000, "pricePerUnit": 52.99 },
          { "min": 7500, "max": 7500, "pricePerUnit": 59.99 },
          { "min": 10000, "max": 10000, "pricePerUnit": 79.99 }
        ],
        "extraOptions": {
          "premiumGuarantee": {
            "additionalPrice": 2.99
      ...
      "YouTube Views": {
        ...
        "minQuantity": 100,
        "maxQuantity": 15000,
        "japServiceId": "4380", // ID usługi na JustAnotherPanel
        "priceRanges": [
          { "min": 100, "max": 100, "pricePerUnit": 3.90 },
          { "min": 250, "max": 250, "pricePerUnit": 4.99 },
          { "min": 350, "max": 350, "pricePerUnit": 6.99 },
          { "min": 750, "max": 750, "pricePerUnit": 9.99 },
          { "min": 1000, "max": 1000, "pricePerUnit": 14.99 },
          { "min": 1800, "max": 1800, "pricePerUnit": 19.99 },
          { "min": 2500, "max": 2500, "pricePerUnit": 22.99 },
          { "min": 3800, "max": 3800, "pricePerUnit": 29.99 },
          { "min": 5000, "max": 5000, "pricePerUnit": 39.99 },
          { "min": 7800, "max": 7800, "pricePerUnit": 52.99 },
          { "min": 10000, "max": 10000, "pricePerUnit": 89.99 },
          { "min": 15000, "max": 15000, "pricePerUnit": 99.99 }
        ],
        "extraOptions": {
          "premiumGuarantee": {
            "additionalPrice": 2.99
      ...
      "YouTube Subscribers": {
        ...
        "minQuantity": 50,
        "maxQuantity": 10000,
        "japServiceId": "9533", // ID usługi na JustAnotherPanel
        "priceRanges": [
          { "min": 50, "max": 50, "pricePerUnit": 3.90 },
          { "min": 100, "max": 100, "pricePerUnit": 5.99 },
          { "min": 250, "max": 250, "pricePerUnit": 8.99 },
          { "min": 500, "max": 500, "pricePerUnit": 12.99 },
          { "min": 750, "max": 750, "pricePerUnit": 18.99 },
          { "min": 1000, "max": 1000, "pricePerUnit": 24.99 },
          { "min": 2500, "max": 2500, "pricePerUnit": 39.99 },
          { "min": 3500, "max": 3500, "pricePerUnit": 46.99 },
          { "min": 5000, "max": 5000, "pricePerUnit": 59.99 },
          { "min": 7500, "max": 7500, "pricePerUnit": 89.99 },
          { "min": 10000, "max": 10000, "pricePerUnit": 149.99 }
        ],
        "extraOptions": {
          "premiumGuarantee": {
            "additionalPrice": 2.99
    ...
    "services": {
      "Spotify Followers": {
        ...
        "priceRanges": [
          { "min": 100, "max": 100, "pricePerUnit": 9.99 },
          { "min": 500, "max": 500, "pricePerUnit": 12.99 },
          { "min": 850, "max": 850, "pricePerUnit": 16.99 },
          { "min": 1000, "max": 1000, "pricePerUnit": 19.99 },
          { "min": 1700, "max": 1700, "pricePerUnit": 24.99 },
          { "min": 3500, "max": 3500, "pricePerUnit": 34.99 },
          { "min": 5000, "max": 5000, "pricePerUnit": 42.99 },
          { "min": 5700, "max": 5700, "pricePerUnit": 49.99 },
          { "min": 8500, "max": 8500, "pricePerUnit": 65.99 },
          { "min": 10000, "max": 10000, "pricePerUnit": 89.99 }
        ],
        "extraOptions": {
          "premiumGuarantee": {
      ...
      "Spotify Plays": {
        ...
        "priceRanges": [
          ...
          { "min": 250, "max": 250, "pricePerUnit": 6.99 },
          { "min": 500, "max": 500, "pricePerUnit": 9.99 },
          { "min": 850, "max": 850, "pricePerUnit": 12.99 },
          { "min": 1000, "max": 1000, "pricePerUnit": 16.99 },
          { "min": 3500, "max": 3500, "pricePerUnit": 24.99 },
          { "min": 5000, "max": 5000, "pricePerUnit": 39.99 },
          { "min": 7500, "max": 7500, "pricePerUnit": 49.99 },
          { "min": 10000, "max": 10000, "pricePerUnit": 69.99 }
        ],
        "extraOptions": {
          "premiumGuarantee": {
            "additionalPrice": 2.99
  ...
  "Twitch": {
    ...
    "services": {
      "Twitch Followers": {
        ...
        "priceRanges": [
          { "min": 100, "max": 100, "pricePerUnit": 5.99 },
          { "min": 350, "max": 350, "pricePerUnit": 7.99 },
          { "min": 500, "max": 500, "pricePerUnit": 11.99 },
          { "min": 850, "max": 850, "pricePerUnit": 16.99 },
          { "min": 1500, "max": 1500, "pricePerUnit": 24.99 },
          { "min": 3500, "max": 3500, "pricePerUnit": 39.99 },
          { "min": 5000, "max": 5000, "pricePerUnit": 49.99 },
          { "min": 8500, "max": 8500, "pricePerUnit": 59.99 }
        ],
        "extraOptions": {
          "premiumGuarantee": {
            "additionalPrice": 2.99
      ...
      "Twitch Views (Clip views)": {
        ...
        "priceRanges": [
          { "min": 100, "max": 100, "pricePerUnit": 5.99 },
          { "min": 350, "max": 350, "pricePerUnit": 8.99 },
          { "min": 500, "max": 500, "pricePerUnit": 11.99 },
          { "min": 1000, "max": 1000, "pricePerUnit": 16.99 },
          { "min": 2500, "max": 2500, "pricePerUnit": 29.99 },
          { "min": 4500, "max": 4500, "pricePerUnit": 39.99 },
          { "min": 7500, "max": 7500, "pricePerUnit": 49.99 },
          { "min": 10000, "max": 10000, "pricePerUnit": 99.99 }
        ],
        "extraOptions": {
